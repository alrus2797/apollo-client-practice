...
export type GetAllCommentsQuery = { __typename?: 'Query', comments: { __typename?: 'CommentFeed', nextOffset?: number | null, results: Array<{ __typename?: 'Comment', id: string, name: string, email: string }> } };
